      ...
      <div className="max-w-3xl mx-auto px-6 text-center">
        ...
        <div className="flex justify-center mb-8 fade-up">
          <img
            src={headshot}
            alt="Nathan Shutter"
            className="w-32 h-32 sm:w-44 sm:h-44 md:w-56 md:h-56 lg:w-64 lg:h-64 rounded-full object-cover object-top border-4 border-base-300"
          />
        </div>
        ...
        <div className="flex gap-5 justify-center fade-up fade-up-4">
          ...
          <a
            href="https://www.linkedin.com/in/nathan-shutter-abc123"
            target="_blank"
            rel="noopener noreferrer"
            aria-label="LinkedIn"
            className="text-base-content/40 hover:text-primary transition-colors duration-200"
